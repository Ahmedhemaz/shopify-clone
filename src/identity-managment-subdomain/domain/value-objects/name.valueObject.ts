...
export class FullName implements IValueObject<FullName> {
  ...
  constructor(firstName: string, lastName: string) {
    ...
    if (isEmpty(this.firstName, { ignore_whitespace: true }))
      throw new EmptyStringException(ErrorMessages.EMPTY_FIRST_NAME);
    if (isEmpty(this.lastName, { ignore_whitespace: true }))
      throw new EmptyStringException(ErrorMessages.EMPTY_LAST_NAME);
  }
  ...
  public getFirstName(): Readonly<string> {
    return this.firstName;
  }
  public getLastName(): Readonly<string> {
    return this.lastName;
  }
  public getFullName(): Readonly<string> {
