...
export class User extends Entity {
  ...
  public changePassword(newPassword: string) {
    ...
    this.userEventEmitter
      .getEventEmitter()
      .emit("PasswordChanged", new PasswordChanged(this.getUId()));
  }
  ...
  public changeMail(newEmail: string) {
    ...
    this.userEventEmitter
      ...
      .emit(
        "MailChanged",
        new EmailChanged(this.getUId(), this.getEmailAddress())
      );
  }
  ...
  public changeName(firstName: string, lastName: string) {
    ...
    this.userEventEmitter
      ...
      .emit(
        "FullNameChanged",
        new FullNameChanged(this.getUId(), this.getFullName())
      );
  }
  ...
  public changeAddress(
    ...
    this.userEventEmitter
      ...
      .emit(
        "AddressChanged",
        new AddressChanged(this.getUId(), this.getAddress())
      );
  }
  ...
  public changeMobileNumber(newMobileNumber: string) {
    ...
    this.userEventEmitter
      ...
      .emit(
        "MobileNumberChanged",
        new MobileNumberchanged(this.getUId(), this.getMobile())
      );
  }
